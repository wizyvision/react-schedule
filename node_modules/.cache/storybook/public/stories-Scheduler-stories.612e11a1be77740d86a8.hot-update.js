...
var SlotBackgroundPropTypes = prop_types__WEBPACK_IMPORTED_MODULE_0___default().shape({
    /**
     * set background of drop, when the appointment can be drop in the slot
     */ dropBg: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().string),
    /**
     * set background of drop, when the appointment is over the slot
     */ overBg: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().string)
});
var SlotPropTypes = prop_types__WEBPACK_IMPORTED_MODULE_0___default().shape({
    /**
     * Set the primary duration - Primary Duration is the duration in header of the scheduler
     * @default 60
     */ primaryDuration: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().number),
    /**
     * Set the secondary duration, Secondary Duration is the duration inside each Primary Duration
     * @default 30
     */ secondaryDuration: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().number),
    /**
     * colSpan should be set accordingly to secondaryDuration
     * @default 2
     */ colSpan: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().number),
    /**
...
//# sourceMappingURL=stories-Scheduler-stories.612e11a1be77740d86a8.hot-update.js.map